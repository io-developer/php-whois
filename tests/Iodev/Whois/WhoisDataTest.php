...
class WhoisTestDataInfoTest  extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadInfoValidation_google_co()
    {
        $info = $this->loadTestDataInfo("google.co", "google.co.txt");
        self::assertEquals("google.co", $info->getDomainName());
        self::assertEquals("", $info->getWhoisServer());
        self::assertEquals(
            self::sort([
                "ns1.google.com",
        ...
        self::assertEquals(strtotime("2010-02-25T01:04:59Z"), $info->getCreationDate());
        self::assertEquals(strtotime("2018-02-24T23:59:59Z"), $info->getExpirationDate());
        self::assertEquals(
            self::sort([
                "clientdeleteprohibited",
                "clienttransferprohibited",
