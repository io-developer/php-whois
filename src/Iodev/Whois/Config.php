...
class Config
{
    ...
    public static function getServersData()
    {
        return [
            ...
            [ "zone" => ".dm", "host" => "whois.nic.cx", "parserType" => "commonFlat" ],
            ...
            [ "zone" => ".vg", "host" => "ccwhois.ksregistry.net", "parserType" => "commonFlat" ],
            [ "zone" => ".vg", "host" => "whois.adamsnames.tc", "parserType" => "commonFlat" ],
