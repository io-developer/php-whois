...
class Config
{
    ...
    public static function getServersData()
    {
        return [
            ...
            [ "zone" => ".mk", "host" => "whois.ripe.net", "parserType" => "block" ],
            ...
            [ "zone" => ".nu", "host" => "whois.nic.nu", "parserType" => "block" ],
            ...
            [ "zone" => ".se", "host" => "whois.iis.se", "parserType" => "block" ],
            [ "zone" => ".se", "host" => "whois.nic-se.se", "parserType" => "block" ],
            ...
            [ "zone" => ".tn", "host" => "whois.ati.tn", "parserType" => "block" ],
    ...
    private static function getBlockParserConfig()
    {
        ...
        $cfg = array_merge($cfg, [
            ...
            "nameServersSubsets" => [
                ...
                [ "__HEADER__" => "Nameservers" ],
                [ "__HEADER__" => "Nameserver in listed order" ],
                [ "nameserver" => "" ],
                [ "nserver" => "" ],
                [ "Name Server Handle" => "" ],
                [ "Hostname" => "" ],
        ...
        $cfg["registrarGroupKeys"] = array_merge($cfg["registrarKeys"], [
            "billing-c",
            "Organisation",
            "organization",
            "organization-loc",
