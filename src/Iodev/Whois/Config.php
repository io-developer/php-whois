...
class Config
{
    ...
    public static function getServersData()
    {
        return [
            ...
            [ "zone" => ".ac.kr", "host" => "whois.nic.or.kr" ],
            ...
            [ "zone" => ".ae", "host" => "whois-check.aeda.net.ae" ],
            ...
            [ "zone" => ".arts.ro", "host" => "whois.rotld.ro" ],
            [ "zone" => ".as", "host" => "whois.nic.as" ],
            [ "zone" => ".asia", "host" => "whois.nic.asia" ],
            [ "zone" => ".asn.au", "host" => "whois.aunic.net" ],
            ...
            [ "zone" => ".au", "host" => "whois.audns.net.au" ],
            ...
            [ "zone" => ".co.kr", "host" => "whois.nic.or.kr" ],
            [ "zone" => ".co.nl", "host" => "whois.co.nl" ],
            [ "zone" => ".co.nz", "host" => "whois.srs.net.nz" ],
            [ "zone" => ".co.rs", "host" => "whois.rnids.rs" ],
            ...
            [ "zone" => ".com.au", "host" => "whois.aunic.net" ],
            ...
            [ "zone" => ".com.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".edu.au", "host" => "whois.aunic.net" ],
            ...
            [ "zone" => ".edu.rs", "host" => "whois.rnids.rs" ],
            ...
            [ "zone" => ".firm.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".go.kr", "host" => "whois.nic.or.kr" ],
            ...
            [ "zone" => ".id.au", "host" => "whois.aunic.net" ],
            ...
            [ "zone" => ".in.rs", "host" => "whois.rnids.rs" ],
            ...
            [ "zone" => ".info.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".nm.kr", "host" => "whois.nic.or.kr" ],
            ...
            [ "zone" => ".nom.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".nt.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".org.ro", "host" => "whois.rotld.ro" ],
            [ "zone" => ".org.rs", "host" => "whois.rnids.rs" ],
            ...
            [ "zone" => ".store.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".tm.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".www.ro", "host" => "whois.rotld.ro" ],
            ...
            [ "zone" => ".xn--3e0b707e", "host" => "whois.kr" ],
            ...
            [ "zone" => ".xn--mgb9awbf", "host" => "whois.registry.om" ],
            [ "zone" => ".xn--mgba3a4f16a", "host" => "whois.nic.ir" ],
            [ "zone" => ".xn--mgbaam7a8h", "host" => "whois.aeda.net.ae" ],
            ...
            [ "zone" => ".xn--wgbl6a", "host" => "whois.registry.qa" ],
